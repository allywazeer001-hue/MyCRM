...
export default function NewTaskPanelPage() {
  ...
  useEffect(() => {
    api.get("/modules")
      .then(({ data }) => setModules((data || []).filter((m: any) => m.isActive)))
      .catch(() => {});
  }, []);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await api.post("/task-panels", payload);
      showToast("Panel created successfully");
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Configure a new task panel for dashboards and module views.</p>
        </div>
