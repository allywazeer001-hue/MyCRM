// GSM-7 vs UCS-2 SMS segment counting — 160 chars/segment (153 when
// concatenated across multiple segments) for plain GSM-7 text, 70/67 for
// anything containing characters outside the GSM-7 alphabet (emoji, most
// non-Latin scripts). This is the standard SMS billing/segment convention
// every gateway (Beem included) uses.
