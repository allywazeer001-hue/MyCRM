// Pure mapping engine for Integration Fields — shared logic, no I/O. A mirrored
// copy lives at mycrm/lib/integration-mapping.ts (same dual-copy pattern already
// used for condition-tree.ts) since backend and frontend aren't a shared workspace.
//
