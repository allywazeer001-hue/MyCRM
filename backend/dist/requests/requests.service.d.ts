...
export declare class RequestsService {
    ...
    private genNumber;
    list(orgId: string, userId: string, filters: any): Promise<({
        _count: {
            comments: number;
            attachments: number;
        };
    ...
    getMyQueue(orgId: string, userId: string): Promise<{
        myRequests: ({
            type: {
                id: string;
                name: string;
    ...
    create(orgId: string, userId: string, body: any): Promise<{
        comments: ({
            author: {
                firstName: string;
                lastName: string;
    ...
    update(id: string, orgId: string, userId: string, body: any): Promise<{
        id: string;
        status: string;
        organizationId: string;
        createdAt: Date;
    ...
    executeAction(id: string, orgId: string, userId: string, body: {
        actionId: string;
        note?: string;
    }): Promise<{
        comments: ({
    ...
    addComment(id: string, orgId: string, userId: string, content: string): Promise<{
        author: {
            firstName: string;
            lastName: string;
            id: string;
